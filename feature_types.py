...
class FeatureDetectorTypes(Enum):   
    ...
    KP2DTINY    = 25  # [end-to-end] joint detector-descriptor - "KP2D: Learning to Localize Keypoints with Point Decomposition"
...
class FeatureDescriptorTypes(Enum):
    ...
    KP2DTINY    = 30  # [end-to-end] joint detector-descriptor - "KP2D: Learning to Localize Keypoints with Point Decomposition"
...
class FeatureInfo(object): 
    ...
    #
    norm_type[FeatureDescriptorTypes.KP2DTINY] = cv2.NORM_L2  
    max_descriptor_distance[FeatureDescriptorTypes.KP2DTINY] = 1.30   # KP2DTINY       
    #
